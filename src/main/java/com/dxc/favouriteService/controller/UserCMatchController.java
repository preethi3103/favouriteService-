package com.dxc.favouriteService.controller;
...
import com.dxc.favouriteService.service.CMatchService;

@RestController
@RequestMapping("/api/v1/cmatchservice")
public class UserCMatchController {
	
	@Autowired
	private CMatchService cmatchService;
	
	public UserCMatchController(CMatchService cmatchService) {
